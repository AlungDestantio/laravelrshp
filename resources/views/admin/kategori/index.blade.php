    ...
    <table class="table datatable">
      ...
      @foreach($data as $d)
        <tr>
          ...
          <td>
            <a href="{{ route('admin.kategori.edit', $d->idkategori) }}" class="btn btn-sm btn-warning">Edit</a>
            <form action="{{ route('admin.kategori.destroy', $d->idkategori) }}" method="POST" class="d-inline" onsubmit="return confirm('Hapus?')">
              @csrf @method('DELETE')
