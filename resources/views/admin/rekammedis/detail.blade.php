...
<div class="container">
    ...
    <div class="card mb-5">
        ...
        <div class="card-body p-4">
            <form action="{{ route('admin.tindakan.store', $rekamMedis->idrekam_medis) }}" method="POST">
                @csrf
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                <div class="d-flex gap-2 justify-content-center">
                                    <a href="{{ route('admin.tindakan.edit', $dt->iddetail_rekam_medis) }}"
                                       class="action-btn btn-edit">
                                        <i class="bi bi-pencil-square me-1"></i> Edit
                                    </a>

                                    <form action="{{ route('admin.tindakan.destroy', $dt->iddetail_rekam_medis) }}"
