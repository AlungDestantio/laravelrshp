...
<div class="container-fluid px-4">
    ...
    <!-- Menu Section -->
    <div class="container">
        <h2 class="menu-section-title">Menu Pemilik</h2>
        
        <div class="row g-4 mb-5 justify-content-center">
            @php
                $menus = [
                    ['icon'=>'bi-heart-pulse-fill','title'=>'Data Hewan','route'=>'pemilik.pet.index', 'desc'=>'Lihat daftar hewan peliharaan yang terdaftar di sistem.'],
                    ['icon'=>'bi-calendar-check-fill','title'=>'Reservasi','route'=>'pemilik.reservasi.index', 'desc'=>'lihat dan pantau jadwal reservasi konsultasi Anda.'],
                    ['icon'=>'bi-clipboard2-pulse-fill','title'=>'Rekam Medis','route'=>'pemilik.rekam-medis.index', 'desc'=>'Lihat riwayat pemeriksaan hewan peliharaan Anda secara lengkap.'],
                ];
            @endphp
