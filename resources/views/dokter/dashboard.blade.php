...
<div class="container-fluid px-4">
    ...
    <!-- Menu Section -->
    <div class="container">
        <h2 class="menu-section-title">Menu Dokter</h2>
        
        <div class="row g-4 mb-5 justify-content-center">
            @php
                $menus = [
                    ['icon'=>'bi-clipboard2-pulse-fill','title'=>'Rekam Medis','route'=>'dokter.rekam-medis.index', 'desc'=>'Daftarkan data pemilik hewan baru agar dapat menggunakan layanan.'],
                ];
            @endphp
